...
RPG.Feats[RPG.FEAT_INTELLEGENT] = new RPG.Feat("Intellegence", "Luckiness");
RPG.Feats[RPG.FEAT_PIETY] = new RPG.Feat("Piety", "Heavenly favor");
RPG.Feats[RPG.FEAT_RESISTENCE] = new RPG.Feat("Resistence", "");
...
RPG.Feats[RPG.FEAT_REGEN_HP] = new RPG.Feat("HP regen", "Hit point regeneration rate", {average:0});
